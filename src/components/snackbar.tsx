...
const Snackbar: React.FC<Props> = ({}) => {
  ...
  return state.show || state.fadeOut ? (
    <div
      ...
      onClick={handleClick}
      className={
        "dark:bg-dark bg-white hover:border-4 cursor-pointer flex justify-center items-center text-xs fixed bottom-10 left-0 right-0 mx-auto h-[5rem] w-[85vw] md:w-[45vw] lg:w-[35vw] prose dark:prose-invert rounded-lg border-2"
      }
    >
